    ...
    <div className="metrics-grid">
      <div className="panel stat-panel">
        ...
        <div className="stat-grid">
          <StatBox label="AVG REG"      value={avg(metrics.registration_latency).toFixed(1)} unit="ms" />
          <StatBox label="AVG AUTH"     value={avg(metrics.auth_latency).toFixed(1)}          unit="ms" />
          <StatBox label="AVG KEY EX"   value={avg(metrics.key_exchange_latency).toFixed(1)}  unit="ms" />
